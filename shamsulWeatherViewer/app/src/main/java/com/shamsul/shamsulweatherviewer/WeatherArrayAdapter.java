...
package com.shamsul.shamsulweatherviewer;
...
class WeatherArrayAdapter extends ArrayAdapter<Weather> {
   ...
   public View getView(int position, View convertView, ViewGroup parent) {
      ...
      viewHolder.lowTextView.setText(
         context.getString(R.string.low_temp, day.minTemp+"\u00B0"+WeatherPref));
      viewHolder.hiTextView.setText(
         context.getString(R.string.high_temp, day.maxTemp+"\u00B0"+WeatherPref));
